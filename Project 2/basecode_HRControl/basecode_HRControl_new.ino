...
duration1 = pulseIn(echoPin1, HIGH); //store first data point 
duration2 = pulseIn(echoPin2, HIGH); //store second data point 
...
//if ((distance1<1.1*actual_distance1)||(distance1<1.1*actual_distance1)) 
